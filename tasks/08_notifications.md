...
- [x] **Wire pitch notifications in pitchController**
...
- [x] **Wire project notifications in projectController**
...
- [x] **Wire contract notifications in contractController**
...
- [x] **Add `category` field to Notification model**
...
- [x] **Add role-based filtering on GET /notifications**
...
- [x] **Add notification bell to DashboardLayout topbar**
...
- [x] **Build full notifications page**
...
- [x] **Add notifications route to all dashboards**
