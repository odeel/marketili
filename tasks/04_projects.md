...
- [x] **Add PATCH /projects/:projectId endpoint (update project fields)**
...
- [x] **Add POST /projects/:projectId/deliverables endpoint**
  - File: `backend/routes/projectRoutes.js` + `backend/controllers/projectController.js`
...
- [x] **Add server-side deadline sorting to project queries**
...
- [x] **Add deadline urgency color to project cards**
...
- [x] **Build deliverable submission UI**
...
- [x] **Add assign member UI in director project detail**
...
- [x] **Add project status update UI (director)**
